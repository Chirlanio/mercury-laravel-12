                        ...
                        <div className="ml-4">
                            ...
                            <div className="mt-2">
                                <p className="text-sm text-gray-500">
                                    Tem certeza que deseja excluir a pagina <strong>{selectedPage?.page_name}</strong>?
                                ...
                                {selectedPage && (
                                    <div className="mt-3 p-3 bg-gray-50 rounded">
                                        <div className="flex items-center gap-2">
                                            {selectedPage.icon && (
                                                <i className={`${selectedPage.icon} text-gray-600`}></i>
                                            )}
                                            <span className="text-sm font-medium text-gray-700">{selectedPage.page_name}</span>
                                        </div>
                                        <div className="text-xs text-gray-500 mt-1">
                                            {selectedPage.controller}@{selectedPage.method}
                                        </div>
                                    </div>
                                )}
                            </div>
