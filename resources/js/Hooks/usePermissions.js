...
const ROLE_PERMISSIONS = {
    [ROLES.SUPER_ADMIN]: [
        ...
        PERMISSIONS.SYNC_MOVEMENTS,
        PERMISSIONS.VIEW_VACATIONS,
        PERMISSIONS.CREATE_VACATIONS,
        PERMISSIONS.EDIT_VACATIONS,
        PERMISSIONS.DELETE_VACATIONS,
        PERMISSIONS.APPROVE_VACATIONS_MANAGER,
        PERMISSIONS.APPROVE_VACATIONS_RH,
        PERMISSIONS.MANAGE_HOLIDAYS,
        PERMISSIONS.VIEW_STOCK_AUDITS,
        PERMISSIONS.CREATE_STOCK_AUDITS,
        PERMISSIONS.EDIT_STOCK_AUDITS,
        PERMISSIONS.DELETE_STOCK_AUDITS,
        PERMISSIONS.AUTHORIZE_STOCK_AUDITS,
        PERMISSIONS.COUNT_STOCK_AUDITS,
        PERMISSIONS.RECONCILE_STOCK_AUDITS,
        PERMISSIONS.MANAGE_STOCK_AUDIT_CONFIG,
    ],
    [ROLES.ADMIN]: [
        PERMISSIONS.VIEW_USERS,
        PERMISSIONS.CREATE_USERS,
