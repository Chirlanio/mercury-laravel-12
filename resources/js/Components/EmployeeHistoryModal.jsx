...
export default function EmployeeHistoryModal({ show, onClose, employeeId, positions, stores, onEmployeeUpdated }) {
    ...
    const [activeTab, setActiveTab] = useState('contracts'); // 'contracts', 'histories', 'events' ou 'schedule'
                ...
                <div className="border-b border-gray-200">
                    <div className="flex items-center justify-between">
                        ...
                        >
                            ...
                            <span>Escala ({scheduleAssignments.length})</span>
                        </button>
                    </nav>
                    {activeTab === 'contracts' && (
                        <Button
                    ...
                    <div>
                        {scheduleAssignments.length === 0 ? (
                            <div className="text-center py-12">
                                ...
                                <h3 className="text-lg font-medium text-gray-900 mb-2">Nenhuma escala atribuída</h3>
                                <p className="text-gray-500">Este funcionário ainda não possui escalas de trabalho.</p>
                            </div>
                        ) : (
                            <div className="space-y-4 max-h-[60vh] overflow-y-auto overflow-x-hidden pr-2">
                                {scheduleAssignments.map((assignment) => (
                                    ...
                                    >
                                            ...
                                            <div>
                                                <div className="flex items-center gap-2 mb-1">
                                                    <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                                                        ...
                                                        {assignment.is_current ? 'Atual' : 'Encerrada'}
                                                    </span>
                                                    <span className="text-sm font-bold text-gray-900">{assignment.schedule_name}</span>
                                                </div>
                                                <div className="text-xs text-gray-500">
                                                    {assignment.weekly_hours} semanais | Desde {assignment.effective_date}
                                            ...
                                            <div className="grid grid-cols-7 gap-1 mb-2">
                                                {assignment.days.map((day) => (
                                                    ...
                                                    >
                                                        ...
                                                        {!day.is_work_day && <div className="text-[10px]">Folga</div>}
                                                        {day.has_override && (
                                        ...
                                        <div className="mt-2 text-xs text-gray-400">
                                            Atribuído por {assignment.created_by}
                                        </div>
                                    </div>
                                ))}
                            </div>
