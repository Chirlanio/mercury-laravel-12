            ...
            <form onSubmit={onSubmit} className="space-y-6 p-6">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label htmlFor="edit_page_name" className="block text-sm font-medium text-gray-700 mb-1">
                                Nome da Página *
                            </label>
                            <input
                                id="edit_page_name"
                        ...
                        <div>
                            <label htmlFor="edit_page_group_id" className="block text-sm font-medium text-gray-700 mb-1">
                                Grupo da Página *
                            </label>
                            <select
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label htmlFor="edit_controller" className="block text-sm font-medium text-gray-700 mb-1">
                                Controller *
                            </label>
                            <input
                                id="edit_controller"
                        ...
                        <div>
                            <label htmlFor="edit_method" className="block text-sm font-medium text-gray-700 mb-1">
                                Método *
                            </label>
                            <input
                                id="edit_method"
                        ...
                        <div>
                            <label htmlFor="edit_menu_controller" className="block text-sm font-medium text-gray-700 mb-1">
                                Menu Controller
                            </label>
                            <input
                        ...
                        <div>
                            <label htmlFor="edit_menu_method" className="block text-sm font-medium text-gray-700 mb-1">
                                Menu Método
                            </label>
                            <input
                                id="edit_menu_method"
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div className="space-y-6">
                        <div>
                            <label htmlFor="edit_icon" className="block text-sm font-medium text-gray-700 mb-1">
                                Ícone
                            </label>
                            <input
                                id="edit_icon"
