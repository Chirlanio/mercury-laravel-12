...
export default function ContractCreateModal({ show, onClose, employeeId, positions, stores, movementTypes, onSuccess }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`/employees/${employeeId}/contracts`, {
                method: 'POST',
                headers: {
            ...
            setErrors({ general: error.message || 'Erro ao criar contrato' });
        } finally {
            setProcessing(false);
        }
    };
    ...
    return (
        <Modal show={show} onClose={onClose} title="Adicionar Contrato" maxWidth="85vw">
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex justify-end space-x-3 pt-4 border-t">
                    ...
                    >
                        {processing ? 'Criando...' : 'Criar Contrato'}
                    </Button>
                </div>
            </form>
        </Modal>
