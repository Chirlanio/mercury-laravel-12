...
/**
 * Registra o módulo `accounting_classes` (Plano de Contas Contábil) como
 * módulo standalone (Fase 0.2 da fundação Budgets/DRE).
 *
 * - central_modules + 7 permissions granulares
 * - CentralPage /accounting-classes vinculada ao menu "Financeiro"
 * - Habilitado em todos os planos (é cadastro de fundação)
 */
return new class extends Migration
{
    private const MODULE_SLUG = 'accounting_classes';
    private const PERMISSION_PREFIX = 'accounting_classes.';
    private const PAGE_ROUTE = '/accounting-classes';
    private const PAGE_NAME = 'Plano de Contas';
    private const PAGE_ICON = 'fas fa-book';
    ...
    private function addModuleToPlans(): void
    {
        ...
        foreach ($plans as $plan) {
            ...
            // Fundação contábil — disponível em todos os planos
