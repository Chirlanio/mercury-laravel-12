...
/**
 * Seeds the Returns (Devoluções/Trocas) module: central_modules,
 * central_permissions, central_role_permissions, central_pages,
 * central_menu_page_defaults, and tenant_modules.
 *
 * Plugs into the existing "E-commerce" top-level menu (criado via
 * CentralNavigationSeeder — não precisa ser criado aqui).
 */
return new class extends Migration
{
    private const MODULE_SLUG = 'returns';
    private const PERMISSION_PREFIX = 'returns.';
    private const PAGE_ROUTE = '/returns';
    private const PAGE_NAME = 'Devoluções';
    private const PAGE_ICON = 'fas fa-box-open';
    private const PARENT_MENU_NAME = 'E-commerce';
    private const CONFIG_PAGE_ROUTE = '/config/return-reasons';
    private const CONFIG_PAGE_NAME = 'Motivos de Devolução';
    ...
    private function seedConfigMenuPageDefaults(): void
    {
        ...
        // Apenas admins podem gerenciar motivos (MANAGE_RETURN_REASONS)
    ...
    private function addModuleToPlans(): void
    {
        ...
        foreach ($plans as $plan) {
            ...
            // Returns (e-commerce) disponível em Professional e Enterprise
