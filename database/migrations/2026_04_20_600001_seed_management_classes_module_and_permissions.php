...
/**
 * Registra o módulo `management_classes` (Plano de Contas Gerencial) —
 * última peça da fundação Budgets/DRE (Fase 0.3).
 *
 * - central_modules + 7 permissions granulares
 * - CentralPage /management-classes vinculada ao menu "Financeiro"
 * - Habilitado em todos os planos (cadastro de fundação)
 */
return new class extends Migration
{
    private const MODULE_SLUG = 'management_classes';
    private const PERMISSION_PREFIX = 'management_classes.';
    private const PAGE_ROUTE = '/management-classes';
    private const PAGE_NAME = 'Plano Gerencial';
    private const PAGE_ICON = 'fas fa-folder-tree';
    ...
    private function addModuleToPlans(): void
    {
        ...
        foreach ($plans as $plan) {
            ...
            // Fundação — disponível em todos os planos
