...
class OrderPaymentStatusController extends ConfigController
{
    ...
    {
        return 'Situações de Ordem de Pagamento';
    }

    protected function viewDescription(): string
    {
        return 'Gerencie as situações disponíveis para ordens de pagamento';
    }

    protected function routeName(): string
    {
        return 'config.order-payment-statuses';
    }
    ...
    {
        return [
            ['name' => 'name', 'label' => 'Nome', 'type' => 'text', 'required' => true, 'placeholder' => 'Ex: Solicitação'],
    ...
    {
        return [
            'name' => 'required|string|max:255|unique:order_payment_statuses,name'.($isUpdate ? ','.$id : ''),
