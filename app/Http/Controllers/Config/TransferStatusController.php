...
class TransferStatusController extends ConfigController
{
    ...
    {
        return 'Situações de Transferência';
    }

    protected function viewDescription(): string
    {
        return 'Gerencie as situações disponíveis para transferências';
    }

    protected function routeName(): string
    {
        return 'config.transfer-statuses';
    }
    ...
    {
        return [
            'name' => 'required|string|max:255|unique:transfer_statuses,name'.($isUpdate ? ','.$id : ''),
