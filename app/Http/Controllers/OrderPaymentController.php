...
class OrderPaymentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'accounting_class_id' => 'nullable|exists:chart_of_accounts,id',
            'management_class_id' => 'nullable|exists:management_classes,id',
            'supplier_id' => 'nullable|exists:suppliers,id',
            'manager_id' => 'nullable|exists:managers,id',
            'management_reason_id' => 'nullable|exists:management_reasons,id',
    ...
    private function formatPaymentDetailed(OrderPayment $p): array
    {
        return array_merge($this->formatPayment($p), [
            ...
            'management_reason_id' => $p->management_reason_id,
