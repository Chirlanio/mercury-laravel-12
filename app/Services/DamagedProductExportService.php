                    ...
                    'Registros' => new class($this->rows) implements FromCollection, WithHeadings, WithMapping, WithTitle {
                        ...
                        public function headings(): array
                        {
                            return [
                                ...
                                'Cor', 'Marca (nome)', 'Marca (código CIGAM)',
                                'Par trocado?', 'Tamanho pé esquerdo', 'Tamanho pé direito',
                                'Avariado?', 'Tipo de dano', 'Pé(s) avariado(s)', 'Tamanho avariado', 'Descrição do dano',
                        ...
                        public function map($p): array
                        {
                            return [
                                ...
                                $p->mismatched_left_size,
                                $p->mismatched_right_size,
